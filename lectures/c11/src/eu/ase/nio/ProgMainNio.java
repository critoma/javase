...
class ProgMainNioFileAsyncCompletionHandler31 {
	
    public static void main(String[] args) {
    	ProgMainNioFileAsyncCompletionHandler31 myNio = new ProgMainNioFileAsyncCompletionHandler31();
    	try {
